 ...
 *
 * This device driver supports the Si7013, Si7020 and Si7021 sensor ICs.
 */
	...
	struct device_attribute *attr, char *buf)
{
	...
	//ltsai
	//calibrate the temperature: -1400 milidegree
	//temperature = ((value*21965)>>13)-46850;
	temperature = ((value*21965)>>13)-48250;
	...
	struct device_attribute *attr, char *buf)
{
	...
	//ltsai
	//calibrate the humidity * 107%
	value = (value*1070)/1000;
