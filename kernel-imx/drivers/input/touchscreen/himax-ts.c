...
//=============================================================================================================
	...
	//#define HX_PORTING_DEB_MSG		1						// Support Driver Porting Message			,default is close
...
//=============================================================================================================
//
//      Segment : Flex Define Variable
//
//=============================================================================================================
	#define FLX_REVERSE_XY_ORIGIN		1
...
//=============================================================================================================
	...
	#define HIMAX_INT_GPIO				107
	#define HIMAX_RST_GPIO				5
	//TODO END
...
#else
	//I2C bus for i.MX6DL
	#define HIMAX_I2C_BUS				1
#endif
	#define HIMAX_I2C_ADDR				0x4a
...
*/			
			...
			// t-larry
			// Reset touch screen
			gpio_direction_output(HIMAX_RST_GPIO, 1);
			msleep(100);
			gpio_set_value(HIMAX_RST_GPIO, 0);       //reset set low
			msleep(100);
			gpio_set_value(HIMAX_RST_GPIO, 1);	//reset set high
			msleep(100);
		...
		static struct himax_i2c_setup_data himax_ts_info = {HIMAX_I2C_BUS, HIMAX_I2C_ADDR, 0, HIMAX_TS_NAME};
